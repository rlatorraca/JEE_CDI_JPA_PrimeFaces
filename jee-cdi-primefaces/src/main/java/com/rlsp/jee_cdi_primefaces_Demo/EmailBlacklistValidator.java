...
public class EmailBlacklistValidator implements Validator<Object>, ClientValidator {

	/**
	 * Usado pela funcao JAVA SCRIPT
	 */
	public static final String VALIDATOR_ID = "com.rlsp.EmailBlacklist";
